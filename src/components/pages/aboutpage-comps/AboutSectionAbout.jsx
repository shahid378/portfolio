        ...
        <section name="About" className='relative w-full h-screen'>
            ...
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-24 lg:py-0 lg:flex-row lg:gap-8'>
                ...
                <div className='flex mt-8 md:mt-0'>
                    <img src={basicInfo.profilePic} alt="My profile" className='rounded-2xl mx-auto w-2/3 max-w-lg md:max-w-sm object-cover md:w-[70rem] shadow-2xl shadow-primary-color/20' style={{ filter: 'drop-shadow(0px -4px 4px rgba(0, 255, 0, 0.5))' }} />
                </div>
                ...
                <div className='flex flex-col justify-center items-center h-[85%] md:h-full'>
                    ...
                    <div className='flex items-center bg-primary-color/20 rounded-md py-2 px-4'>
                        <img className='h-[30px] w-auto mr-2' src={basicInfo.countryIcon} alt="" />
                        <h2 className='text-lg sm:text-xl md:text-2xl md:py-1 font-semibold text-white'>{basicInfo.countryNage}</h2>
                    </div>
                    
                    <p className='text-md md:text-lg text-gray-300 py-4 max-x-md text-justify'>{basicInfo.knowMoreText1}</p>

                    <p className='text-md md:text-lg text-gray-300 max-x-md text-justify'>{basicInfo.knowMoreText2}</p>
                </div>
            </div>
